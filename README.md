...
I bring **15 years of mission-critical operations** (high-volume SLAs, fleet logistics, data auditing, and process governance) into modern AI engineering. The result is a rare combination: someone who understands **LangGraph stateful orchestration and multi-LLM guardrails** *and* what it actually costs when a system fails at scale.
...
- 🔭 **Currently:** B.Sc. Computer Science (final year) + Postgrad in ML Engineering @ **FIAP**
...
A maioria dos projetos de IA morre na demo. Os meus são desenhados para a parte que ninguém gosta de discutir: **confiabilidade, governança e não alucinar na frente de um usuário real.**

Trago **15 anos de operações de missão crítica** (SLAs de alta volumetria, logística de frotas, auditoria de dados e governança de processos) para a engenharia de IA moderna. O resultado é uma combinação rara: alguém que domina **orquestração stateful com LangGraph e guardrails multi-LLM** *e* sabe o custo real de um sistema que falha em escala.
...
- 🔭 **Atualmente:** Ciência da Computação (último ano) + Pós em ML Engineering @ **FIAP**
- 🌐 **Portfólio:** [vitorsilva.page](https://vitorsilva.page)
- 💼 **LinkedIn:** [/in/vitorsilva-aieng](https://www.linkedin.com/in/vitorsilva-aieng/)
- 📍 Curitiba, Brasil · aberto a remoto internacional
