...
**Unindo 14 anos de resiliência e disciplina operacional à vanguarda da Engenharia de Software.**

Sou um desenvolvedor em transição estratégica, integrando uma sólida trajetória profissional nos Correios com o estado da arte da Inteligência Artificial. Meu foco é a construção de **Agentes de IA (Agentic AI)** e sistemas inteligentes que não apenas funcionam, mas escalam com robustez e entregam valor real ao negócio.
...
**Tutor de Inglês Inteligente (Agentic AI)**
- **Stack:** Python (FastAPI), Gemini API e Flutter.
- **Diferencial:** Orquestração de agentes para aprendizado ativo e feedback pedagógico em tempo real via IA Generativa.

### 🤸 [CorpoEmAcao](https://github.com/vdfs89/corpo-em-acao)
**Plataforma de Alta Performance para Musculação**
- **Stack:** Flutter e Python.
- **Visão de Futuro:** Implementação de **Visão Computacional** para análise postural e contagem automática de repetições.

### 🎵 [Symphonic](https://github.com/vdfs89/symphonic)
**Laboratório de Áudio Generativo**
- Pesquisa e experimentação com modelos SOTA de som e música (Suno, Udio, Stable Audio).
...
- **Lifestyle:** Praticante de musculação, entusiasta de energia solar/eólica e marcenaria.
- **Mindset:** "O código limpo é a fundação; a arquitetura robusta é o que sustenta o crescimento."
...
<p align="left">
  <img height="180" src="https://github-readme-stats.vercel.app/api?username=vdfs89&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true" />
  <img height="180" src="https://github-readme-stats.vercel.app/api/top-langs/?username=vdfs89&layout=compact&theme=tokyonight" />
</p>
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/vdfs89/)
